...
import com.example.kharcha_theexpensesmanagement.Activity.Settlement_member2;
import com.example.kharcha_theexpensesmanagement.Model.GroupModel;
import com.example.kharcha_theexpensesmanagement.R;

import java.util.ArrayList;

public class grpAdapter3 extends RecyclerView.Adapter<grpAdapter3.MyViewHolder> {

    Context context;
    ArrayList<GroupModel> allArrayList;

    public grpAdapter3(Context context) {
    ...
    @Override
    public grpAdapter3.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.group_list3, parent, false);
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // Toast.makeText(view.getContext(),"Selected Groups : "+grpData.getGroup_Name(),Toast.LENGTH_SHORT).show();
                Intent i1 =new Intent(view.getContext(), Settlement_member2.class);
                i1.putExtra("GroupName3", grpData.getGroup_Name());
                i1.putExtra("GroupID3",grpData.getGroup_id());
