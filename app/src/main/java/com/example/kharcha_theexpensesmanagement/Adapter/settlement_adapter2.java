...
import com.example.kharcha_theexpensesmanagement.Activity.Group_settlement;
...
public class settlement_adapter2 extends RecyclerView.Adapter<settlement_adapter2.MyViewHolder> {
    Context context;
...
//    int mTotalAmount=0;
    ...
    public settlement_adapter2(Context context) {
...
//        firebaseFirestore = FirebaseFirestore.getInstance();
        ...
        holder.arrow_forword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i1=new Intent(context, Group_settlement.class);
                i1.putExtra("GroupNameSettle2",memberModel.getGroup_Name());
                i1.putExtra("GroupIdSettle2",memberModel.getGroup_id());
                i1.putExtra("MemberIdSettle2",memberModel.getMember_id());
                i1.putExtra("MemberNameSettle2",memberModel.getMemberName());
                i1.putExtra("MemberMnoSetttle2",memberModel.getMemberMno());
